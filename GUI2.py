...
class ResumeScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Текстовые метки
        layout.add_widget(Label(text="Зайцев Дмитрий", font_size=32, pos=(10, 330), color=(0, 0, 0, 1)))
        ...
        layout.add_widget(Label(text="(￣o￣) zzZZzzZZ ", font_size=20, pos=(-255, -5), color=(0, 0, 0, 1)))
        layout.add_widget(Label(text="Опыт:", font_size=25, pos=(-290,-30), color=(0, 0, 0, 1)))
        layout.add_widget(Label(text="Искусство, Трейдинг", font_size=20, pos=(-225,-55), color=(0, 0, 0, 1)))
